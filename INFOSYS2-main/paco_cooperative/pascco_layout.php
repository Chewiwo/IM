...
function pascco_header(string $title, string $active = ''): void
{
    ...
    <head>
        ...
        <style>
            ...
            * { box-sizing: border-box; }
            ...
            .slip-form { background: white; border: 1px solid var(--line); padding: 28px; }
            .slip-form label { display: block; font-weight: bold; margin: 14px 0 6px; }
            .slip-form input, .slip-form select, .slip-form textarea { border: 1px solid #b8c8bd; border-radius: 3px; font: inherit; padding: 11px; width: 100%; }
            .slip-preview { background: #fffdf6; border: 2px solid var(--deep-blue); margin-top: 28px; padding: 28px; }
            .slip-preview img { height: 58px; width: 58px; }
    ...
    <header class="site-header">
        ...
        <nav class="site-nav" aria-label="Primary navigation">
            ...
            <?php endforeach; ?>
            <a class="<?php echo $active === 'slip' ? 'active' : ''; ?>" href="slip.php" <?php echo $active === 'slip' ? 'aria-current="page"' : ''; ?>>Generate Slip</a>
        </nav>
